...
<template>
    <AppLayout title="Add Student">
        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            <FormSection @submitted="addStudent">
                <template #title>
                    Add New Student
                </template>
                ...
                <template #form>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <div v-show="! photoPreview" class="mt-2">
                            <img src="https://static.vecteezy.com/system/resources/previews/008/442/086/original/illustration-of-human-icon-user-symbol-icon-modern-design-on-blank-background-free-vector.jpg" alt="student profile" class="rounded-full h-20 w-20 object-cover">
                        </div>
